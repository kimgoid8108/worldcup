            ...
            <div className="flex justify-between items-center mb-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  {getFifaRanking(country.id) && (
                    <p className="text-sm text-blue-600 font-semibold mt-1">
                      FIFA 랭킹: {getFifaRank(country.id)}위 ({getFifaRanking(country.id)}점)
                    </p>
                  )}
                </div>
              </div>
                  ...
                  {players.length > 0 ? (
                    players.map((player) => (
                      <button
                        ...
                        className="w-full p-3 bg-gray-50 hover:bg-gray-100 rounded-lg border border-gray-200 hover:border-blue-300 transition-all text-left"
                      >
